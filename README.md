...
- [Hyper MinHash](https://github.com/LiveRamp/HyperMinHash-java) - A probabilistic data structure for computing set union, intersection, and cardinality in loglog space. 
